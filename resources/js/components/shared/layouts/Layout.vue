<template>
	<div class="md:h-screen md:flex md:flex-col">
		...
		<header>
			<nav class="md:flex md:flex-shrink-0">
				<div
					...
					<AppDropdown class="md:hidden fill-current text-white" placement="bottom-end">
				...
				<div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center">
					...
					<AppDropdown class="mt-1" placement="bottom-end">
						<div class="flex items-center cursor-pointer select-none group">
							...
							<i
								class="fas fa-chevron-down w-5 h-5 group-hover:text-indigo-600 text-gray-700 focus:text-indigo-600 flex align-middle mt-1"></i>
						</div>
		...
		<div class="md:flex md:flex-grow md:overflow-hidden">
			<nav class="hidden md:block bg-indigo-800 text-white flex-shrink-0 w-56 p-12 overflow-y-auto">
				<slot />
			</nav>
